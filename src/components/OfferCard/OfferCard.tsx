...
import CallBell from "@/assets/icons/tagsWhite/CallBell.svg?url";
import Campfire from "@/assets/icons/tagsWhite/Campfire.svg?url";
import Garage from "@/assets/icons/tagsWhite/Garage.svg?url";
import Dog from "@/assets/icons/tagsWhite/Dog.svg?url";
import ExternalLinkIcon from "@/assets/icons/arrow-up-right.svg?url";
...
const OfferCard = ({
	...
	const icons = [CallBell, Campfire, Garage, Dog];
