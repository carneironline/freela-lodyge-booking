        ...
        <section>
            ...
            <section className={styles.header}>
                ...
                <p className={styles.subtitle}>
                    <span className={styles.location}>Angra dos Reis,</span> Rio de Janeiro, Brasil  ·  Apenas 2 horas de você
                </p>
            </section>
            <OfferDetailsHeader />
            ...
            <section className={styles.content}>
                <main className={styles.mainContent}>
                    <article className={styles.articleBody}>
                        <input type="checkbox" className={styles.readMoreState} id="post-2" />
                        ...
                        <p className={styles.readMoreWrap}>
                            ...
                            perfeita para dias ensolarados. Ali também se encontra um convidativo daybed, 
                            ideal para relaxar enquanto se aprecia a exuberância do jardim. 
                            Um caminho serpenteia até um deck posicionado sobre um canal de águas 
                            límpidas e cristalinas, onde uma surpresa aguarda os visitantes. 
                            A lareira externa é o cenário perfeito para o fim do dia, oferecendo 
                    ...
                    />
                    <LodyDiscovery 
                        title="Experiências Reais da Lody Descoberta"
                    />
                    ...
                    <section className={styles.lodyDiscoveryGuide}>
                        ...
                        <p className={styles.guideText}>
                            ...
                            Descoberta para você aproveitar cada segundo nesse fantástico lugar.
                        </p>
                        <a href="#" className={styles.guideButton}>Ver Guia Lodyge <Image src={arrowRight} alt="Seta para direita"/></a>
                    </section>
